...
\label{t2a}
\end{table}
Wie wir auch erwartet haben, bleiben die Transferraten RAM$\rightarrow$GPU und GPU$\rightarrow$RAM unverändert. Da diese Daten Tabelle \ref{t2a} entnommen werden können, sind sie in den Tabellen \ref{t2b_Mega} und \ref{t2b_10Mega} nicht weiter aufgeführt. Da noch addiert wird, sinkt die Transferrate im RAM. Mit steigender Blockgröße steigt die Leistung GPU$\rightarrow$GPU anfangs fast linear, bis die Kurve bei Blockgröße 24 abflacht.
