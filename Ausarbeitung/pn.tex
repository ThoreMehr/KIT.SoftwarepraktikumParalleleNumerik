...
\TODO{Welche Methode führt beim schlechter parallelisierbaren Algorithmus wohl zum besten Ergebnis?}
...
\begin{table}
	...
	\begin{tabular}{r|r|r|r|r|r}
		...
		8 & GPU a) & $153$ & $6,9$ & $4,51\times10^{-2}$ & $5,21\times10^{-5}$ \\
		& GPU c) & $153$ & $6,02$ & $3,93\times10^{-2}$ & $5,21\times10^{-5}$ \\
		\hline
		& CPU & $961$ & $2,5$ & $2,6\times10^{-3}$ & $1,26\times10^{-5}$ \\
		9 & GPU a) & $285$ & $78,5$ & $2,75\times10^{-1}$ & $1,31\times10^{-5}$ \\
		& GPU c) & $285$ & $71,5$ & $2,51\times10^{-1}$ & $1,31\times10^{-5}$ \\
	\end{tabular}
...
Aus Tabelle \ref{tab:cgcomp} ergeben sich Beschleunigungen von $1,06, 1,146, 1,097$ für $l=7,l=8,l=9$ von der reinen GPU Variante gegenüber deren, die sowohl auf der GPU als auch auf der CPU rechnet.
