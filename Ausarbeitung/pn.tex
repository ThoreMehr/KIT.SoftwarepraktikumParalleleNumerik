...
\begin{table}
	...
	\end{tabular}
	\caption{Laufzeiten unserer Parallelisierung gegenüber der sequentiellen Version. Getestet wurde auf dem Rechner \emph{i82sn07}. Um Ungenauigkeiten auszugleichen wurden die Zeiten jeweils über $10$ (für große Eingaben über $5$) Durchläufe gemittelt.}
	\label{pi_runtime}
\end{table}
...
\TODO{Hier kommt der Text zum c-Teil}
