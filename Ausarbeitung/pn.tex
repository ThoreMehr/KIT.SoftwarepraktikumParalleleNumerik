...
Als letzter Aspekt für das erste Projekt wurde aus mehreren Krylow-Unterraumverfahren das CG-Verfahren ausgesucht und implementiert. Dieses sollte das gleiche Problem wie auch schon vorher das Gauß-Seidel-Verfahren lösen (Poisson-Problem), aber mit der Erwartung dass es schneller zum gewünschten Resultat kommt, was wir auch tatsächlich beobachten konnten.
