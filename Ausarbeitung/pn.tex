...
\begin{table}
	...
	\begin{tabular}{r|r|r||r||r|r|@{ \dots}|r|r||r|r}
		\multicolumn{3}{c||}{Problemgröße} & Seq. & \multicolumn{2}{c|@{ \dots}|}{4 Threads} & \multicolumn{2}{c||}{16 Threads}  & \multicolumn{2}{c}{32 Threads} \\
		$l$ & $d$ & $n$ & Laufzeit & Laufzeit & Speedup & Laufzeit & Speedup & Laufzeit & Speedup \\
		\hline
		4 & 15 & 225 & 0,005 & 0,007 & 0,357 & 0,008 & 0,625 & 1,361 & 0,0389 \\
		5 & 31 & 961 & 0,053 & 0,056 & 0,473 & 0,049 & 1,08 & 4,041 & 0,178 \\
		...
		9 & 511 & 261.121 & 1340 & 943 & 1,42 & 504 & 2,67 & 177 & 7,57 \\
	\end{tabular}
	\caption{\emph{Speedup} und \emph{Efficiency} zwischen Gauß-Seidel-Verfahren und CG-Verfahren für das Problem aus Aufgabe \ref{p1a5}.}
