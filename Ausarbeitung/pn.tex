...
\documentclass[twoside,twocolums,a4paper,compsoc,conference]{IEEEtran}
...
\begin{table*}
	...
	\label{2b_2000}
\end{table*}
\subsubsection{OpenMP-Profiler ommp}\label{p1a2c}
